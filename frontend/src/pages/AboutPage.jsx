        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-gray-50 dark:from-gray-900 dark:to-gray-800 p-8 rounded-2xl border-2 border-blue-200 dark:border-gray-700">
                <div className="relative max-w-2xl mx-auto" style={{ paddingBottom: '120%' }}>
                  ...
                  >
                    ...
                    <path 
                      ...
                      stroke="#2196F3"
                      strokeWidth="2"
                      className="dark:fill-gray-700 dark:stroke-blue-400"
                    />
                  </svg>
                  ...
                  {projectLocations.map((location, index) => (
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 w-4 h-4 bg-blue-600 dark:bg-blue-400 rounded-full opacity-50 group-hover:scale-150 transition-transform duration-300"></div>
                      </div>
                      {/* Tooltip */}
                      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-gray-900 px-3 py-2 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 whitespace-nowrap z-10">
                        <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{location.city}</div>
                        <div className="text-xs text-gray-600 dark:text-gray-400">{location.projects} Projects</div>
                      </div>
                    </div>
                  ))}
                </div>
